...
<p class="comment">
今週の講義内で使用する、csvファイルのデータは、平井 et al.（2022）『教育・心理系研究のための Rによるデータ分析　論文作成への理論と実践集』のものです。
</p>
...
## 参考文献
- 平井 et al.（2022）『教育・心理系研究のための Rによるデータ分析　論文作成への理論と実践集』東京図書
...
<!--chapter:end:14-Week14_tidyverse.Rmd-->
